return {
  ...
  },
  {
    ...
    cmd = {
      "FasterDisableAllFeatures",
      "FasterDisableBigfile",
      "FasterDisableFastmacro",
      "FasterDisableFiletype",
      "FasterDisableIlluminate",
      "FasterDisableIndentblankline",
      "FasterDisableLsp",
      "FasterDisableLualine",
      "FasterDisableMatchparen",
      "FasterDisableSyntax",
      "FasterDisableTreesitter",
      "FasterDisableVimopts",
      "FasterEnableAllFeatures",
      "FasterEnableBigfile",
      "FasterEnableFastmacro",
      "FasterEnableFiletype",
      "FasterEnableIlluminate",
      "FasterEnableIndentblankline",
      "FasterEnableLsp",
      "FasterEnableLualine",
      "FasterEnableMatchparen",
      "FasterEnableSyntax",
      "FasterEnableTreesitter",
      "FasterEnableVimopts",
      "FasterPrintConfig",
    },
  },
