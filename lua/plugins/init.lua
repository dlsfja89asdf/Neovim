return {
    ...
    },
    {
        ...
        opts = {
            ensure_installed = {
                "lua-language-server", "stylua", "prettier", "prettierd", "asm-lsp", "asmfmt", "cpplint", "cpptools",
                "csharpier", "clangd", "clang-format", "pyright", "typos", "typos-lsp", "powershell-editor-services",
            },
        },
    },
    {
    ...
    },
    {
        ...
        config = function()
            ...
            -- mappings
            vim.keymap.set("n", "<leader>pp", "<cmd>Telescope neovim-project discover<CR>",
                { desc = "Discover projects" })
            vim.keymap.set("n", "<leader>po", "<cmd>Telescope neovim-project history<CR>",
